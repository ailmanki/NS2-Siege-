...
local function InitCustomizationOptions(customizeElements)
    ...
    customizeElements.MarineVariantName:SetValue(GetVariantName(kMarineVariantsData, options.marineVariant))
    customizeElements.ShoulderPad:SetValue(kShoulderPadNames[options.shoulderPadIndex])
    customizeElements.SkulkVariantName:SetValue(GetVariantName(kSkulkVariantsData, options.skulkVariant))
    customizeElements.GorgeVariantName:SetValue(GetVariantName(kGorgeVariantsData, options.gorgeVariant))
    ...
    customizeElements.AxeVariantName:SetValue(GetVariantName(kAxeVariantsData, options.axeVariant))
    customizeElements.ShotgunVariantName:SetValue(GetVariantName(kShotgunVariantsData, options.shotgunVariant))
    customizeElements.FlamethrowerVariantName:SetValue(GetVariantName(kFlamethrowerVariantsData, options.flamethrowerVariant))
    customizeElements.GrenadeLauncherVariantName:SetValue(GetVariantName(kGrenadeLauncherVariantsData, options.grenadeLauncherVariant))
    customizeElements.WelderVariantName:SetValue(GetVariantName(kWelderVariantsData, options.welderVariant))
    customizeElements.HMGVariantName:SetValue(GetVariantName(kHMGVariantsData, options.hmgVariant))
...
local function OnMarineChanged(formElement)
    ...
    Client.SetOptionInteger("marineVariant", FindVariant(kMarineVariantsData, marineVariantName))
    MenuPoses_SetPose("idle", "marine", true)
    MenuPoses_Function():SetCoordsOffset("marine")
    SendPlayerVariantUpdate()
end
...
local function OnExoChanged(formElement)
    ...
    Client.SetOptionInteger("exoVariant", FindVariant(kExoVariantsData, exoVariantName))
...
local function OnRifleChanged(formElement)
    ...
    Client.SetOptionInteger("rifleVariant", FindVariant(kRifleVariantsData, rifleVariantName))
...
local function OnPistolChanged(formElement)
    ...
    Client.SetOptionInteger("pistolVariant", FindVariant(kPistolVariantsData, pistolVariantName))
...
local function OnAxeChanged(formElement)
    ...
    Client.SetOptionInteger("axeVariant", FindVariant(kAxeVariantsData, axeVariantName))
...
local function OnShotgunChanged(formElement)
    ...
    Client.SetOptionInteger("shotgunVariant", FindVariant(kShotgunVariantsData, shotgunVariantName))
...
local function OnFlamethrowerChanged(formElement)
    ...
    Client.SetOptionInteger("flamethrowerVariant", FindVariant(kFlamethrowerVariantsData, flamethrowerVariantName))
...
local function OnGrenadeLauncherChanged(formElement)
    ...
    Client.SetOptionInteger("grenadeLauncherVariant", FindVariant(kGrenadeLauncherVariantsData, grenadeLauncherVariantName))
...
local function OnWelderChanged(formElement)
    ...
    Client.SetOptionInteger("welderVariant", FindVariant(kWelderVariantsData, welderVariantName))
...
local function OnHMGChanged(formElement)
    ...
    Client.SetOptionInteger("hmgVariant", FindVariant(kHMGVariantsData, hmgVariantName))
...
local function OnSkulkChanged(formElement)
    ...
    Client.SetOptionInteger("skulkVariant", FindVariant(kSkulkVariantsData, skulkVariantName))
...
local function OnGorgeChanged(formElement)
    ...
    Client.SetOptionInteger("gorgeVariant", FindVariant(kGorgeVariantsData, gorgeVariantName))
...
local function OnLerkChanged(formElement)
    ...
    Client.SetOptionInteger("lerkVariant", FindVariant(kLerkVariantsData, lerkVariantName))
...
local function OnFadeChanged(formElement)
    ...
    Client.SetOptionInteger("fadeVariant", FindVariant(kFadeVariantsData, fadeVariantName))
...
local function OnOnosChanged(formElement)
    ...
    Client.SetOptionInteger("onosVariant", FindVariant(kOnosVariantsData, onosVariantName))
    ...
    if not self.customizeNocturneUnpackWindow then
        ...
        okButton:AddEventCallbacks({ OnClick = function()
            if self.customizeNocturneUnpackWindow then
                ...
                --Opens Tundra Pack
                self:OpenCustomizeWindow( function() Client.ExchangeItem( kNocturneAlienPackItemId, kUnpackNocturneBundleItemId ) end )
    ...
    if not self.customizeForgeUnpackWindow then
        ...
        okButton:AddEventCallbacks({ OnClick = function()
            if self.customizeForgeUnpackWindow then
                ...
                --Opens Tundra Pack
                self:OpenCustomizeWindow( function() Client.ExchangeItem( kForgeMarinePackItemId, kUnpackForgeBundleItemId ) end )
...
function GUIMainMenu:OnInventoryUpdated()
    ...
    elseif GetOwnsItem(kNocturneAlienPackItemId) then
        self:CreateNocturneUnpackWindow()
    elseif GetOwnsItem(kForgeMarinePackItemId) then
...
function GUIMainMenu:CreateCustomizeWindow()
    ...
    local marineVariantNames = BuildVariantsTable( kMarineVariants, kMarineVariantsData )
    local skulkVariantNames = BuildVariantsTable( kSkulkVariants, kSkulkVariantsData )
    local gorgeVariantNames = BuildVariantsTable( kGorgeVariants, kGorgeVariantsData )
    ...
    local axeVariantNames = BuildVariantsTable( kAxeVariants, kAxeVariantsData )
    local shotgunVariantNames = BuildVariantsTable( kShotgunVariants, kShotgunVariantsData )
    local flamethrowerVariantNames = BuildVariantsTable( kFlamethrowerVariants, kFlamethrowerVariantsData )
    local grenadeLauncherVariantNames = BuildVariantsTable( kGrenadeLauncherVariants, kGrenadeLauncherVariantsData )
    local welderVariantNames = BuildVariantsTable( kWelderVariants, kWelderVariantsData )
    local hmgVariantNames = BuildVariantsTable( kHMGVariants, kHMGVariantsData )
