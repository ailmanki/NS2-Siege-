...
function MenuPoses_SetPose(pose, modelType, destroy)
    ...
    if modelType == "skulk" then
        modelPath =  "models/alien/" .. modelType .. "/" .. modelType .. GetVariantModel(kSkulkVariantsData, options.skulkVariant)
    elseif modelType == "gorge" then
        modelPath =  "models/alien/" .. modelType .. "/" .. modelType .. GetVariantModel(kGorgeVariantsData, options.gorgeVariant)
    elseif modelType == "lerk" then
        modelPath =  "models/alien/" .. modelType .. "/" .. modelType .. GetVariantModel(kLerkVariantsData, options.lerkVariant)
    ...
    elseif modelType == "rifle" then
        modelPath = "models/marine/rifle/rifle" .. GetVariantModel(kRifleVariantsData, options.rifleVariant)
    elseif modelType == "pistol" then
        modelPath = "models/marine/pistol/pistol" .. GetVariantModel(kPistolVariantsData, options.pistolVariant)
    elseif modelType == "axe" then
        modelPath = "models/marine/axe/axe" .. GetVariantModel(kAxeVariantsData, options.axeVariant)
    elseif modelType == "shotgun" then
        modelPath = "models/marine/shotgun/shotgun" .. GetVariantModel(kShotgunVariantsData, options.shotgunVariant)
    elseif modelType == "flamethrower" then
        modelPath = "models/marine/flamethrower/flamethrower" .. GetVariantModel(kFlamethrowerVariantsData, options.flamethrowerVariant)
    elseif modelType == "grenadeLauncher" then
        modelPath = "models/marine/grenadelauncher/grenadelauncher" .. GetVariantModel(kGrenadeLauncherVariantsData, options.grenadeLauncherVariant)
    elseif modelType == "welder" then
        modelPath = "models/marine/welder/welder" .. GetVariantModel(kWelderVariantsData, options.welderVariant)
    elseif modelType == "hmg" then
        modelPath = "models/marine/hmg/hmg" .. GetVariantModel(kHMGVariantsData, options.hmgVariant)
    ...
    elseif modelType == "tunnel" then
        ...
        modelPath = "models/marine/" .. sexType .. "/" .. sexType .. GetVariantModel(kMarineVariantsData, options.marineVariant)
    end

    if model == nil and modelPath ~= nil then
        model = CreateAnimatedModel(modelPath)
    else
        model = CreateAnimatedModel("models/marine/" .. sexType .. "/" .. sexType .. GetVariantModel(kMarineVariantsData, options.marineVariant))
