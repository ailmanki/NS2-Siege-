...
AcidSpray.AttackSpeedMod = 4.12 -- 0.445s  3.06 -- 0.6s --2.66  -- 0.69second
local kAcidSpraySpread = Math.Radians(6) -- degrees
...
local function CreateAcidProjectile(self, player, index)
    ...
    if not Predict then
        ...
        player:CreatePredictedProjectile( "AcidMissile", startPoint, startVelocity, 0, 0, 9.8 ) -- 20 )
