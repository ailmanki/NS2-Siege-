...
function GUIMenuCustomizeScreen:InitializeNavElements()
    ...
    self.mainMarineTopBar:AddButton( "structuresButton", "Structures & Units", function() self.SetDesiredActiveView(self, gCustomizeSceneData.kViewLabels.MarineStructures) end, marineBarStyle )
    ...
    self.mainAlienBottomBar:AddButton( "alienStructsButton", "Structures & Units", function() self.SetDesiredActiveView(self, gCustomizeSceneData.kViewLabels.AlienStructures) end, alienBarStyle )
    ...
    {
        label = "KHARAA", --TODO localize? (requires new string) ...how in the hell was THIS string not localized?!
...
function GUIMenuCustomizeScreen:InitAlienStructuresElements(scene)
    ...
    self.alienStructsIntructions:SetText("Left/Right click structures to cycle skins") --TODO Localize
...
function GUIMenuCustomizeScreen:InitAlienTunnelElements(scene)
    ...
    self.tunnelsIntructions:SetText("Left/Right click Tunnel to cycle skins") --TODO Localize
...
function GUIMenuCustomizeScreen:InitAlienLifeformElements(scene)
    ...
    local prowlerStr = "Prowler" --Locale.ResolveString("PROWLER")
    ...
    self.lifeformsIntructions:SetText("Left/Right click a Lifeform to cycle its skins") --TODO Localize
...
function GUIMenuCustomizeScreen:InitMarineExoElements(scene)
    ...
    self.exoIntructions:SetText("Left/Right click " .. exoSuitStr .. " to cycle skins") --TODO Localize
...
function GUIMenuCustomizeScreen:InitMarineStructureElements(scene)
    ...
    self.marineStructsIntructions:SetText("Left/Right click structures to cycle skins") --TODO Localize
...
function GUIMenuCustomizeScreen:InitMarinePatchElements(scene)
    ...
    self.patchesIntructions:SetText("Left/Right click to cycle " .. patchStr .. "es ") --TODO Localize
...
function GUIMenuCustomizeScreen:InitMarineWeaponElements(scene)
    ...
    self.weaponsIntructions:SetText("Left/Right click to cycle Weapon skins") --TODO Localize
...
function GUIMenuCustomizeScreen:InitMarineArmorElements(scene)
    ...
    self.armorIntructions:SetText("Left/Right click to cycle Marine Armor skins") --TODO localize
    ...
    local CycleGender = function()
        ...
        _self.genderChangeLabel:SetText( "Change to " .. (newType == "Male" and "Female" or "Male") ) --TODO Localize
    end
