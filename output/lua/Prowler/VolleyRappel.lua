...
VolleyRappel.AttackSpeedMod = 0.3833 --0.58 --0.515
...
VolleyRappel.kSpreadVectors =
{
    ...
    GetNormalizedVector(Vector(0.0, -0.05, kSpreadDistance)),
    GetNormalizedVector(Vector(0.0, 0.05, kSpreadDistance)),
    
    GetNormalizedVector(Vector(-0.4, 0.0, kSpreadDistance)),
    GetNormalizedVector(Vector( 0.4, 0.0, kSpreadDistance)),
    
    GetNormalizedVector(Vector(-0.7, -0.1, kSpreadDistance)),
    GetNormalizedVector(Vector( 0.7, -0.1, kSpreadDistance)),
    
    GetNormalizedVector(Vector(-1.0, 0.15, kSpreadDistance)),
    GetNormalizedVector(Vector( 1.0, 0.15, kSpreadDistance)),
